...
const AboutGallery = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="py-24 bg-white overflow-hidden font-poppins"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              >
                <h4 className="text-[15px] font-bold text-gray-700 mb-3 ml-1">
                  Best ratings
                </h4>
                ...
                <div className="space-y-5">
                  <div className="flex items-center -space-x-3">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="w-9 h-9 rounded-full border-[3px] border-white overflow-hidden shadow-sm"
                      >
                        <img
                    ...
                    <div className="w-9 h-9 rounded-full border-[3px] border-white bg-[#ffcb0f] flex items-center justify-center text-[9px] font-black shadow-sm">
                      N
                    </div>
                    {[4].map((i) => (
                      <div
                  ...
                  <div className="flex items-center -space-x-3">
                    ...
                    {[4].map((i) => (
                      ...
                      >
                        <img
                          src={`https://i.pravatar.cc/100?img=${i + 33}`}
                          alt="user"
                        />
                      </div>
                    ))}
            ...
            <div className="mb-8">
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                ...
                <p>
                  ...
                  techniques with traditional craftsmanship to deliver
                  exceptional results. From initial design to final completion,
                  we ensure every detail meets the highest standards of quality
                  and excellence.
                </p>
              </div>
            </div>
