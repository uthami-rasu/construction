          ...
          <div className="max-w-xl">
            ...
            >
              <h4 className="text-white font-bold text-xs md:text-sm tracking-[0.4em] uppercase">
                Building Construction <span className="text-[#00C2FF]">Excellence</span>
              </h4>
            </motion.div>
            ...
            <motion.p 
              ...
              className="text-white/80 text-base md:text-lg mb-12 leading-relaxed font-medium"
            >
            ...
            <motion.button 
              ...
              className="group relative bg-[#00C2FF] hover:bg-[#00A3D9] text-white px-10 py-5 font-black uppercase tracking-widest text-sm transition-all hover:scale-105 active:scale-95 skew-x-[-15deg] rounded-sm overflow-hidden shadow-2xl"
            >
              <span className="relative z-10 skew-x-[15deg]">Get Started Today</span>
            </motion.button>
          </div>
          ...
          <div className="relative order-first lg:order-last">
            <div className="relative h-[400px] md:h-[550px] w-full max-w-[500px] mx-auto">
              ...
              <motion.div 
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 w-[75%] h-[90%] rounded-[2.5rem] overflow-hidden shadow-2xl z-10 border-8 border-[#0B1221]"
              >
                <img src={imgMain} alt="Main Service" className="w-full h-full object-cover" />
              </motion.div>
              ...
              <motion.div 
                ...
                className="absolute right-0 top-0 w-[45%] h-[40%] rounded-[2rem] overflow-hidden shadow-2xl z-20 border-8 border-[#0B1221]"
              >
                <img src={imgTop} alt="Construction Process" className="w-full h-full object-cover" />
              </motion.div>
              ...
              <motion.div 
                ...
                className="absolute right-[5%] bottom-[-5%] w-[45%] h-[40%] rounded-[2rem] overflow-hidden shadow-2xl z-20 border-8 border-[#0B1221]"
              >
                <img src={imgBottom} alt="Expert Planning" className="w-full h-full object-cover" />
              </motion.div>
