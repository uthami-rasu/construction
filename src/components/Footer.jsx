        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-6">
          ...
          <div className="group lg:col-span-5">
            ...
            <div className="flex flex-wrap items-center gap-4 lg:flex-nowrap">
              {/* Timings Box */}
              <div className="flex items-center gap-3 p-2.5 rounded-lg bg-gradient-to-r from-amber-100 to-yellow-50 border border-amber-300 hover:border-amber-400 shadow-sm transition-all duration-300 inline-flex w-fit flex-shrink-0">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-amber-500 font-bold text-[15px] mb-5 uppercase tracking-wider relative">
              Quick Links
              <span className="absolute -bottom-2 left-0 w-8 h-[2px] bg-gradient-to-r from-amber-400 to-transparent rounded-full" />
            </h4>
            <ul className="space-y-3 pt-1">
              {quickLinks.map((link) => (
                <li key={link.label} className="overflow-hidden">
                  ...
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-amber-500 opacity-0 group-hover/link:opacity-100 transition-all duration-300 transform -translate-x-2 group-hover/link:translate-x-0" />
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 pt-1">
              <li>
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-amber-100 border border-amber-300 flex items-center justify-center flex-shrink-0 group-hover/contact:bg-amber-200 group-hover/contact:border-blue-500 transition-all duration-300">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="rounded-lg overflow-hidden border border-amber-300 shadow-md shadow-amber-100 hover:shadow-amber-200 transition-all duration-300 pt-1">
              <iframe
