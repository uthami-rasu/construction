    ...
    <footer className="relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-6">
          ...
          <div className="group lg:col-span-5">
            <div className="mb-4 flex items-center justify-center lg:justify-start">
              <div className="relative p-4 md:p-6 rounded-2xl bg-gradient-to-br from-sky-100 via-sky-50 to-blue-50 border border-sky-200 shadow-[0_10px_30px_rgba(135,206,235,0.3)] hover:shadow-[0_15px_40px_rgba(135,206,235,0.4)] transition-all duration-300 overflow-hidden inline-block">
                ...
                <div className="absolute inset-2 rounded-xl border border-sky-100/50" />
            ...
            <div className="flex flex-wrap items-center gap-4 lg:flex-nowrap">
              {/* Timings Box */}
              <div className="flex items-center gap-3 p-2.5 rounded-lg bg-gradient-to-r from-sky-100 to-blue-50 border border-sky-300 hover:border-sky-400 shadow-sm transition-all duration-300 inline-flex w-fit flex-shrink-0">
                <div className="w-8 h-8 rounded-lg bg-sky-200 flex items-center justify-center flex-shrink-0">
                  <Clock className="w-4 h-4 text-sky-600" />
                </div>
                <span className="text-gray-700 text-xs font-semibold pr-2 whitespace-nowrap">
                  Mon - Sat · 9 AM - 8 PM
                </span>
              </div>
              ...
              <div className="flex gap-2 items-center flex-nowrap">
                ...
                <a
                  ...
                  className="w-8 h-8 rounded-lg border border-sky-300 bg-white flex items-center justify-center text-sky-600 hover:bg-sky-50 hover:border-sky-600 hover:scale-110 shadow-sm transition-all duration-300"
                >
          ...
          <div className="lg:col-span-2">
            <h4 className="text-sky-500 font-bold text-[15px] mb-5 uppercase tracking-wider relative">
              Quick Links
              <span className="absolute -bottom-2 left-0 w-8 h-[2px] bg-gradient-to-r from-sky-400 to-transparent rounded-full" />
            </h4>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 pt-1">
              <li>
                <a
                  href="https://maps.google.com/?q=217/4,+Sri+Lakshmi+Complex,+Rajapalayam"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group/contact flex gap-3 text-gray-700 text-xs md:text-[13px] hover:text-blue-600 transition-all duration-300 font-medium"
                >
                  ...
                  <span className="leading-snug pt-0.5">
                    217/4, Sri Lakshmi Complex, Rajapalayam - 626 117
                  </span>
                </a>
              </li>
              <li>
                <a
                  href="mailto:krrishconstruction95@gmail.com"
                  className="group/contact flex gap-3 text-gray-700 text-xs md:text-[13px] hover:text-blue-600 transition-all duration-300 font-medium"
                >
                  <div className="w-8 h-8 rounded-lg bg-sky-100 border border-sky-300 flex items-center justify-center flex-shrink-0 group-hover/contact:bg-sky-200 group-hover/contact:border-blue-500 transition-all duration-300">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="rounded-lg overflow-hidden border border-sky-300 shadow-md shadow-sky-100 hover:shadow-sky-200 transition-all duration-300 pt-1">
              <iframe
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 py-6 transition-all duration-300">
        <div className="text-center">
          <p className="text-gray-600 text-[13px] md:text-sm tracking-wide font-medium">
