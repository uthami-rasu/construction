      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end mb-24 max-w-7xl mx-auto">
          <div>
            ...
            <motion.h2
              ...
              className="text-3xl md:text-5xl lg:text-5xl font-black text-[#1a1a1a] tracking-tighter uppercase"
            >
              Our Process
            </motion.h2>
          </div>
              ...
              >
                ...
                <h3
                  className={`text-xl font-black mb-4 uppercase tracking-tight transition-colors duration-500 ${
                    index === activeStep ? "text-[#FFCB0F]" : "text-[#1a1a1a]"
                  }`}
                >
                  {step.title}
                </h3>
        ...
        <div className="mt-24 md:mt-32 text-center">
          ...
          <motion.div
            ...
            transition={{ delay: 0.2 }}
          >
            <button onClick={()=> window.open('https://wa.me/918610813419', '_blank')} className="group relative bg-[#FFCB0F] text-black px-6 md:px-10 py-3 md:py-4 font-black uppercase tracking-widest text-xs md:text-sm transition-all hover:scale-110 active:scale-95 shadow-xl [transform:skewX(-15deg)] rounded-sm inline-flex items-center gap-3 overflow-hidden">
