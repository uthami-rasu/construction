...
const steps = [
  {
    title: "Planning",
    description: "We begin with a thorough consultation to understand your vision, requirements, and budget. Our team develops a comprehensive plan that outlines every detail of your project.",
    icon: Search,
    color: "bg-[#9d72ff]",
  ...
  },
  {
    ...
    description: "Our architects and designers create detailed blueprints and 3D renderings. We work closely with you to refine the design until it perfectly matches your expectations.",
    icon: Shapes,
    color: "bg-[#4cc9f0]",
  ...
  {
    title: "Construction",
    description: "Our skilled team brings the design to life with precision and quality craftsmanship. We maintain open communication and provide regular updates throughout the construction phase.",
    icon: Hammer,
    color: "bg-[#ffcb0f]",
  ...
  {
    title: "Handover",
    description: "After thorough quality checks and final inspections, we hand over your completed project. We ensure everything meets our high standards and your complete satisfaction.",
    icon: CheckCircle,
    color: "bg-[#f72585]",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end mb-24 max-w-7xl mx-auto">
          <div>
            <motion.h4 
              ...
              viewport={{ once: true }}
              className="text-[#ffcb0f] font-bold text-sm uppercase tracking-[0.4em] mb-4"
            >
              How We Work
            </motion.h4>
            <motion.h2 
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
            {steps.map((step, index) => (
              ...
              >
                {/* Icon Container */}
                <div className={`relative mb-8 w-24 h-24 rounded-2xl ${step.color} ${step.shadow} flex items-center justify-center transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3 shadow-xl`}>
        ...
        <div className="mt-24 md:mt-32 text-center">
          ...
          <motion.button
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.2 }}
            className="group relative bg-[#00C2FF] hover:bg-[#00A3D9] text-white px-10 py-5 font-black uppercase tracking-widest text-sm transition-all hover:scale-105 active:scale-95 shadow-xl skew-x-[-15deg] rounded-sm inline-flex items-center gap-3 overflow-hidden"
          >
