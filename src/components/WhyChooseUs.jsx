  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[10%] left-[-5%] w-[400px] h-[400px] bg-[#FFCB0F]/5 rounded-full blur-[100px]"></div>
        <div className="absolute bottom-[10%] right-[-5%] w-[500px] h-[500px] bg-[#FFB800]/5 rounded-full blur-[120px]"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 bg-[#FFCB0F]/5 px-5 py-2 rounded-full border border-[#FFCB0F]/10 mb-6"
          >
            <Star className="w-3.5 h-3.5 text-[#FFB800] fill-current" />
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[#FFB800]">
              Our Core Values
            </span>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="h-1 bg-linear-to-r from-[#FFB800] to-[#FFCB0F] mx-auto my-10 rounded-full"
            ></motion.div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {reasons.map((reason, index) => (
            <motion.div
              ...
              whileHover={{ y: -15 }}
              className="relative group p-10 rounded-[3rem] bg-linear-to-b from-gray-50/50 to-white border border-gray-100/50 hover:shadow-[0_40px_80px_-20px_rgba(255,184,0,0.15)] hover:border-[#FFB800]/30 transition-all duration-500 text-center"
            >
              ...
              <div className="relative mb-10 flex items-center justify-center">
                ...
                <div className="absolute -top-2 -right-2 w-4 h-4 rounded-full bg-[#FFB800]/40 blur-[2px] group-hover:animate-ping"></div>
                <div className="absolute -bottom-2 -left-2 w-3 h-3 rounded-full bg-[#FFCB0F]/40 blur-[2px]"></div>
              </div>

              {/* Text Content */}
              <h3 className="text-xl font-black text-gray-900 mb-5 tracking-tight group-hover:text-[#FFB800] transition-colors">
                {reason.title}
              </h3>
        ...
        >
          {/* Outer Glow */}
          <div className="absolute inset-0 bg-[#FFB800]/20 blur-[50px] opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>

          <div className="relative bg-[#2d2400]/95 backdrop-blur-xl rounded-[2.5rem] p-6 md:p-10 border border-white/10 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16 overflow-hidden">
            {/* Background Accent */}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-6 md:gap-10">
              {/* Icon Badge */}
              <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-[#FFB800] to-[#E69D00] flex items-center justify-center shadow-lg shadow-[#FFB800]/20">
              ...
              <div className="text-center md:text-left">
                <h4 className="text-2xl md:text-3xl font-black text-white leading-tight">
                  Ready to transform{" "}
                  <span className="font-playfair italic font-medium text-[#FFB800]">
                    your vision?
                  </span>
                </h4>
